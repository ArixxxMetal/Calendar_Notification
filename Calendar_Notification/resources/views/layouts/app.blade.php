...
<script type="text/javascript" src="{{asset('bootstrap-4.4.1-dist/js/bootstrap.js')}}"></script>
<script type="text/javascript" src="{{asset('jquery/jquery.js')}}"></script>
<script type="text/javascript" src="{{asset('bootstrap-4.4.1-dist/js/bootstrap.bundle.min.js')}}"></script>
</html>
